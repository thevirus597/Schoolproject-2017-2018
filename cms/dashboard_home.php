...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="content wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <?php $sql = mysqli_query($con,"SELECT * FROM homepagina ORDER BY id ASC");
                            ...
                            <div class="ibox-content product-box">
                                ...
                                <div class="product-desc">
                                    ...
                                    <div class="m-t text-right">
                                        ...
                                        <button name="delete" id='<?php echo $row['id'] ?>' class="btn btn-xs btn-outline btn-primary delete_slide"><i class="fa fa-trash-o" style="font-size:20px;color:red"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form  id="add_form" action="php/insert_slideshow.php" method="POST" enctype="multipart/form-data">
                            <label>Photo</label>
                            <input type="file" name="image" id="image" data-msg-required="Vul dit veld in!" class="form-control" required="true" />
                            <br/>
                            <label>Caption</label>
                            <input type="text" name="caption" id="caption" data-msg-required="Vul dit veld in!" class="form-control caption" required="true" />
                            <br/>
                            <br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br/>
                        <form id="update_form" action="php/update_slideshow.php" method="POST" enctype="multipart/form-data">
                            <input type="text" id="slide_modal_id" class="hidden" name="slide_id">
                            <label>Photo</label>
                            <input type="file" name="image" id="image" data-msg-required="Vul dit veld in!" class="form-control image" required="true" />
                            <br/>
                            <label>Caption</label>
                            <input type="text" name="caption" id="slide_modal_caption" data-msg-required="Vul dit veld in!" class="form-control caption" required="true" />
                            <br/>
